...
const localAgents: Agent[] = [
  ...
  // Brand Marketing Agents
  {
    ...
    status: 'approved',
    submitterId: 'system',
    submitterEmail: 'admin@transparentai.com',
    submitterName: 'Transparent AI Team',
    submissionDate: '2024-01-15T00:00:00Z',
    reviewedBy: 'system',
    reviewerEmail: 'admin@transparentai.com',
    reviewerName: 'Transparent AI Team',
    approvalDate: '2024-01-15T00:00:00Z',
    rejectionReason: '',
    auditTrail: [],
  ...
  },
  {
    ...
    description: 'AI-powered campaign development agent that creates engaging marketing campaigns, social media content, and promotional materials.',
    provider: 'openai',
    route: '/agents/campaign-creator-agent',
    metadata: {
      tags: ['campaign-creation', 'social-media', 'promotional', 'content-generation', 'marketing'],
  ...
  {
    id: 'brand-analytics-agent',
    name: 'Brand Analytics Agent',
    description: 'Advanced brand performance analytics agent that tracks brand sentiment, market share, and campaign effectiveness across global markets.',
    provider: 'anthropic',
    route: '/agents/brand-analytics-agent',
    metadata: {
      tags: ['brand-analytics', 'sentiment-analysis', 'market-share', 'campaign-effectiveness', 'global-markets', 'marketing'],
  ...
  },
  {
    ...
    description: 'AI social media management agent that creates engaging posts, monitors conversations, and manages social media presence across platforms.',
    provider: 'openai',
    route: '/agents/social-media-agent',
    metadata: {
      tags: ['social-media', 'content-creation', 'conversation-monitoring', 'platform-management', 'engagement', 'marketing'],
  ...
  },
  {
    ...
    description: 'AI-powered customer behavior analysis agent that provides deep insights into consumer preferences, trends, and purchasing patterns.',
    provider: 'anthropic',
    route: '/agents/customer-insights-agent',
    metadata: {
      tags: ['customer-insights', 'behavior-analysis', 'consumer-preferences', 'trends', 'purchasing-patterns', 'marketing'],
  ...
  {
    id: 'event-planner-agent',
    name: 'Event Planner Agent',
    description: 'AI event planning and coordination agent that helps organize brand events, product launches, and promotional activities.',
    provider: 'openai',
    route: '/agents/event-planner-agent',
    metadata: {
      tags: ['event-planning', 'product-launches', 'promotional-activities', 'coordination', 'brand-events', 'marketing'],
